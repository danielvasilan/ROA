...
folder are mapped to the application's root namespace, 'RoaApp'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'RoaApp' in the same way
as `"RoaApp/sass/src"`.
